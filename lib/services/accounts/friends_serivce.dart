...
class FriendsService extends ChangeNotifier {
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> getFriendData(String uid) async {
    return await _firestore.collection('friends').doc(uid).get();
  }
  ...
  Future<List<String>> getFriendsList([String? uid]) async {
    ...
    return friendData.toString().contains('friends') ? friendData['friends'] : [];
  }
